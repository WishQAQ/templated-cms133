...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"num\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a>\r\n";
            $indexpage="<a class=\"num\" href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"num\">首页</a>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"num\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a>\r\n";
            $endpage="<a class=\"num\" href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"num\">末页</a>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a class=\"num\" href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a>\r\n";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"num\" href='".$purl."PageNo=$prepagenum'>上一页</a>\r\n";
            $indexpage="<a class=\"num\" href='".$purl."PageNo=1'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"num\">首页</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"num\" href='".$purl."PageNo=$nextpagenum'>下一页</a>\r\n";
            $endpage="<a class=\"num\" href='".$purl."PageNo=$totalpage'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"num\">末页</a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a class=\"num\" href='".$purl."PageNo=$j'>".$j."</a>\r\n";
            }
        }
