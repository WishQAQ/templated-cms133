    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['preimg'] = "<a class=\"page\" href='$mlink'>上一篇：{$preRow['title']}</a>"; 
            }
            else
            {
                $this->PreNext['pre'] = "没有了 ";
                $this->PreNext['preimg'] ="<a class=\"page\" href='javascript:void(0);'>上一篇：没有啦</a>";
            }
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['nextimg'] = "<a class=\"page\" href='$mlink'>下一篇：{$nextRow['title']}</a> ";
            }
            else
            {
                $this->PreNext['next'] = "没有了 ";
                $this->PreNext['nextimg'] ="<a class=\"page\" href='javascript:void(0);'>下一篇：没有啦</a> ";
            }
        }
        if($gtype=='pre')
        {
