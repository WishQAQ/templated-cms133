...
$(document).ready(function() {
    ...
    $('.class-down').click(function(){     // 分类
        var _dl = $(this).parent("li").find("dl");
        if(_dl.length != 0){
            $(this).toggleClass("class-up");
            _dl.toggle();
        }
    });
    ...
    $(".order_discuss_btn").click(function(){
        $(".order_view_pf_bg").show();
    });
    $(".order_view_pf_title p").click(function(){
        $(".order_view_pf_bg").hide();
    });
